...
public class ManagerEmployeeProfileViewController implements ViewController {
    @Override
    ...
    public void show(Context context) {
        HTMLWriter writer = new HTMLWriter("src/main/html/manager/view_employee_profile.html");
