...
public class EmployeeDashboardViewController implements ViewController {
    @Override
    public boolean isAuthorized(User user) {
        AuthorizationController authorization = new AuthorizationController(Roles.EMPLOYEE);
    ...
    public void show(Context context) {
        HTMLWriter writer = new HTMLWriter("src/main/html/employee/dashboard.html");
